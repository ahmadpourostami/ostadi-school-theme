...
class Ostadi_Elements_Assets {
    ...
    public function frontend_assets() {
        ...
        wp_enqueue_style( 'ostadi-home', OSTADI_ELEMENTS_URL . 'assets/css/home.css', array( 'ostadi-elements' ), OSTADI_ELEMENTS_VERSION );
    ...
    public function editor_assets() {
        ...
        wp_enqueue_style( 'ostadi-home-editor', OSTADI_ELEMENTS_URL . 'assets/css/home.css', array( 'ostadi-elements-editor' ), OSTADI_ELEMENTS_VERSION );
    }
}
