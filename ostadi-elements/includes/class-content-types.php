...
class Ostadi_Elements_Content_Types {
    ...
    private function register_video() {
        ...
        register_taxonomy( 'ostadi_video_category', 'ostadi_video', array(
            'labels' => array( 'name' => 'دسته‌بندی ویدئو', 'singular_name' => 'دسته‌بندی ویدئو' ),
            'public' => true,
            'show_in_rest' => true,
            'hierarchical' => true,
        ...
        register_taxonomy( 'ostadi_video_tag', 'ostadi_video', array(
            'labels' => array( 'name' => 'برچسب ویدئو', 'singular_name' => 'برچسب ویدئو' ),
            'public' => true,
            'show_in_rest' => true,
            'hierarchical' => false,
    ...
    private function register_podcast() {
        ...
        register_taxonomy( 'ostadi_podcast_category', 'ostadi_podcast', array(
            'labels' => array( 'name' => 'دسته‌بندی پادکست', 'singular_name' => 'دسته‌بندی پادکست' ),
            'public' => true,
            'show_in_rest' => true,
            'hierarchical' => true,
        ...
        register_taxonomy( 'ostadi_podcast_tag', 'ostadi_podcast', array(
            'labels' => array( 'name' => 'برچسب پادکست', 'singular_name' => 'برچسب پادکست' ),
            'public' => true,
            'show_in_rest' => true,
            'hierarchical' => false,
